<div class="frame-shadow flex-col-sm pad-sm bord-rad-md back-color-prime speed-norm transform-up-hover">
    @if (!empty($img))
        <img class="bord-rad-smr w-100 h-100" src="{{ $img }}" alt="">
    @endif

    <div class="flex-col pad-smr flex-start">
